  ...
  return (
    <>
      <Column className="p-4">
        ...
        <button
          className="uppercase px-4 py-2 rounded-full bg-secondary text-white flex items-center gap-2 w-fit text-sm mb-4"
          onClick={addProduct}
        >
          Add Products
        </button>
              ...
              {products.map((p) => (
                <tr key={p.id} className="odd:bg-green-50 even:bg-green-100">
                  ...
                  <td className="p-2">
                    <div className="flex flex-row gap-2 items-center">
                      <button
                        className="uppercase px-4 py-2 rounded-full bg-secondary text-white inline-block text-sm flex items-center gap-2"
                        onClick={() => {
      ...
      >
        ...
        >
          ...
          <blockquote className="bg-secondary text-white p-2 shadow-md rounded-md mt-4">
